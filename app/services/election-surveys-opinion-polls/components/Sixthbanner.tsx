  ...
  return (
    <section className="relative overflow-hidden h-[500px] md:min-h-screen flex items-center">
      ...
      <div
        ...
        style={{
          backgroundImage: "url('/home-clients-4.webp')",
        }}
      />
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="max-w-5xl flex flex-col mt-10 md:mt-30">
            ...
            <p className="text-sm md:text-lg text-white mb-8 leading-relaxed tracking-wide">
                Providing accurate political and social research, from constituency-level surveys to public opinion polling.
            </p>

            <h1 className="text-4xl md:text-7xl font-bold font-sans-serif text-white mb-6 md:mb-10 leading-tight tracking-tight">
